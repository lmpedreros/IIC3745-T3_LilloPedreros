...
class ContactMessageControllerTest < ActionDispatch::IntegrationTest
  setup do
    ...
    @contact_message = ContactMessage.create!(name: 'John Doe', mail: 'john@example.com', phone: '+56998765432', title: 'Test', body: 'This is a test message.')
    sign_in @user_admin
  end
  ...
  test "should create contact message with valid attributes" do
    assert_difference('ContactMessage.count') do
      post contacto_crear_url, params: { contact: { name: 'Joe', mail: 'joe@example.com', phone: '+56998765432', title: 'Hello', body: 'This is another test message.' } }
    end
  ...
  test "should delete all contact messages as admin" do
    ContactMessage.create!(name: 'Jane Doe', mail: 'jane@example.com', phone: '+56998765432', title: 'Hello', body: 'This is another test message.')
