...
class ContactMessageTest < ActiveSupport::TestCase
  test 'should save contact message with valid attributes' do
    contact_message = ContactMessage.new(title: 'Valid Title', body: 'Valid body content', name: 'Valid Name',
                                         mail: 'valid@example.com', phone: '+56912345678')
  ...
  test 'should not save contact message without title' do
    contact_message = ContactMessage.new(body: 'Valid body content', name: 'Valid Name', mail: 'valid@example.com',
                                         phone: '+56912345678')
  ...
  test 'should not save contact message with long title' do
    contact_message = ContactMessage.new(title: 'a' * 51, body: 'Valid body content', name: 'Valid Name',
                                         mail: 'valid@example.com', phone: '+56912345678')
  ...
  test 'should not save contact message without body' do
    contact_message = ContactMessage.new(title: 'Valid Title', name: 'Valid Name', mail: 'valid@example.com',
                                         phone: '+56912345678')
  ...
  test 'should not save contact message with long body' do
    contact_message = ContactMessage.new(title: 'Valid Title', body: 'a' * 501, name: 'Valid Name',
                                         mail: 'valid@example.com', phone: '+56912345678')
  ...
  test 'should not save contact message without name' do
    contact_message = ContactMessage.new(title: 'Valid Title', body: 'Valid body content', mail: 'valid@example.com',
                                         phone: '+56912345678')
  ...
  test 'should not save contact message with long name' do
    contact_message = ContactMessage.new(title: 'Valid Title', body: 'Valid body content', name: 'a' * 51,
                                         mail: 'valid@example.com', phone: '+56912345678')
  ...
  test 'should not save contact message with invalid mail' do
    contact_message = ContactMessage.new(title: 'Valid Title', body: 'Valid body content', name: 'Valid Name',
                                         mail: 'invalid-email', phone: '+56912345678')
  ...
  test 'should not save contact message with long mail' do
    contact_message = ContactMessage.new(title: 'Valid Title', body: 'Valid body content', name: 'Valid Name',
                                         mail: "#{'a' * 51}@example.com", phone: '+56912345678')
  ...
  test 'should not save contact message with invalid phone' do
    contact_message = ContactMessage.new(title: 'Valid Title', body: 'Valid body content', name: 'Valid Name',
                                         mail: 'valid@example.com', phone: '+569123456')
